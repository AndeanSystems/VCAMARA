...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="btn_crud">
            ...
            <asp:ImageButton CssClass="btn_crud_button" ID="btn_guardar" ToolTip="Guardar" runat="server" ImageUrl="~/Resources/Imagenes/u14_normal.png"/>
            <asp:ImageButton CssClass="btn_crud_button" ID="btn_nuevo" ToolTip="Nuevo" runat="server" ImageUrl="~/Resources/Imagenes/u13_normal.jpg" OnClick="btn_nuevo_Click"/>
    ...
    <div class="tabBody" id="tblopemanual">
        <asp:MultiView id="multiTabs" ActiveViewIndex="0" Runat="server">
            <asp:View ID="view1" runat="server">
                <asp:HiddenField  value="0" ID="hdf_idRegla" runat="server"/>
                ...
                <label class="input_right_L" for="ddl_Archivo">Archivo (*)</label>
                <asp:DropDownList CssClass="input_right" ID="ddl_Archivo" runat="server" Height="25px" Width="15%"></asp:DropDownList>

                <label class="input_right_T" for="ddl_tipo_linea">Tipo Linea (*)</label>
                <asp:DropDownList CssClass="input_right" ID="ddl_tipo_linea" runat="server" Height="25px" Width="15%"></asp:DropDownList>

                <label class="label_to" for="ddl_comprobante">Caracter Inicial (*)</label>
                <asp:TextBox runat="server" ID="txt_caracter_inicial" CssClass="input_to numeric" Height="25px" Width="14.6%"></asp:TextBox>

                <label class="input_right_L" for="txt_largo_Campo">Largo Campo (*)</label>
                <asp:TextBox runat="server" ID="txt_largo_Campo" CssClass="input_right numeric" Height="25px" Width="14.6%"></asp:TextBox>  

                <label class="input_right_T" for="ddl_codasegurado_m">Información Campo (*)</label>
                <asp:TextBox runat="server" ID="txt_informacion" CssClass="input_right" Height="25px" Width="14.6%"></asp:TextBox>  

                <label class="label_to" for="txt_formato">Formato Contenido (*)</label>
                <asp:TextBox runat="server" ID="txt_formato" CssClass="input_to" Height="25px" Width="14.6%"></asp:TextBox>

                <label class="input_right_L" for="ddl_tipo_validacion">Tipo de Validación (*)</label>
                <asp:DropDownList CssClass="input_right" ID="ddl_tipo_validacion" runat="server" Height="25px" Width="15%">
                ...
                <label class="input_right_T" for="txt_regla_validacion">Regla de Validación (*)</label>
                <asp:TextBox runat="server" ID="txt_regla_validacion" CssClass="input_to numeric" Height="25px" Width="14.6%"></asp:TextBox>
