...
namespace VidaCamara.Web.WebPage.Inicio
{
    public partial class frmLogin : System.Web.UI.Page
    {
        ...
        public bool ValidarUsuarioEnActiveDirectory()
        {
            ...
            if (txtUsuario.Text.Equals("reaseguros"))//.FnValidarUsuario(ConfigurationManager.AppSettings.Get("Dominio"), txtUsuario.Text, txtContrasena.Text, ConfigurationManager.AppSettings.Get("UrlLDAP")))
            {
